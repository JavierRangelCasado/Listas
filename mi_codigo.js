  ...
  /***    ###########################################
    ...
    */
    ...
    // A continuación usa reduce para calcularlo y mostrarlo por consola
                ...
                */
    lista_alemania = ciudades.filter(ciudad=>ciudad.nombre.includes("Germany"))
    console.log(lista_alemania)

    lista_tomate = lista_alemania.map(x => x.precio_tomate)
    console.log(lista_tomate.reduce((ac,n) => ac+ parseFloat(n) , 0)/lista_tomate.length);
